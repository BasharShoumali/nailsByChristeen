...
CREATE TABLE `workday` (
  ...
  `firstApp` varchar(100) DEFAULT NULL,
  `secondApp` varchar(100) DEFAULT NULL,
  `thirdApp` varchar(100) DEFAULT NULL,
  `fourthApp` varchar(100) DEFAULT NULL,
  `fifthApp` varchar(100) DEFAULT NULL,
...
INSERT INTO `workday` VALUES ('2025-09-08','318699155',NULL,NULL,NULL,NULL);
